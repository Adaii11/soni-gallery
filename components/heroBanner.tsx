...
export default function HeroBanner() {
    ...
    const slides = [
        ...
        },
        {
            ...
            buttonText: "Location",
            buttonLink: "https://maps.google.com/?q=7454+S+Olympia+Ave,+Tulsa,+OK+74132",
        },
    ...
    return(
            ...
            <div className="relative w-full h-[60rem] overflow-hidden font-sans">
                            ...
                            >
                                ...
                                <div className="absolute left-1/2 -translate-x-1/2 bottom-[15rem] text-white max-w-lg flex flex-col">
                                    ...
                                    <div className="flex justify-center">
                                        ...
                                        className="mt-[0.5rem] text-[1.125rem] font-light px-[1rem] py-[0.5rem] border border-black rounded bg-black transition-colors duration-400 hover:bg-linear-to-r from-(--secondary) to-(--secondary-2) hover:border hover:font-normal hover:border-white"
                                    >
                                        {slide.buttonText}
                                    </Link>
                                    </div>
                ...
                <div className="hidden md:flex">
                    ...
                    >
                        <svg className="text-white transition-colors duration-400 hover:text-black" width="45" height="45" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    >
                        <svg className="text-white transition-colors duration-400 group-hover:text-black" width="45" height="45" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="25" cy="25" r="25" fill="white" />
                            <line className='transition-colors duration-300' x1="18" y1="24" x2="32" y2="24" stroke="currentColor" strokeWidth="2" />
